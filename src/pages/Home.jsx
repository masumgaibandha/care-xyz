...
export default function Home() {
    return (
        <>
            <Helmet>
                <title>Care.xyz | Baby Sitting & Elderly Care Service</title>
                <meta
                    name="description"
                    content="Care.xyz helps you book trusted baby care, elderly care, and sick care services based on duration and location."
                />
            </Helmet>
